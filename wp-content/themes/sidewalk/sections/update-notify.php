...
<div id="welcome-panel" class="welcome-panel sdw-welcome-panel">
	...
	<div class="welcome-panel-content">
		...
		<p class="about-description">Sidewalk has been successfully updated to version <?php echo THEME_VERSION; ?></p>
		...
		<div class="welcome-panel-column-container">
				...
				<a href="http://mekshq.com/docs/sidewalk-change-log" target="_blank" class="button button-primary button-hero">View change log</a>
				</div>
